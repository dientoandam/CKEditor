...
<link rel="shortcut icon" type="image/png" href="/Resources/Imagephoto/logo.png" /><link href="/Components/lightbox/css/lightbox.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function popunder() {
            ...
            var articleId = '' != '' ? '' : 'b4031ebe-e802-4402-a49a-5769943872a5/Telerik.Web.UI.WebResource.axd';
            var topicId = '' != '' ? '' : '';
            var moduleId = '' != '' ? '' : '';
            if (articleId != '') {
                if (window.history.state == null) {
                    ...
                    window.history.replaceState({ ArticleId: articleId }, "ArticleId", "/ArticleId/" + articleId + "/" + retitleUrl('CONTACT INFORMATION'));
                }
            }
            if (topicId != '') {
                if (window.history.state == null) {
...
<body class="body" onload='popunder();'>
    ...
    <form name="form1" method="post" action="Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=0d902e2e-1e07-477b-a7e3-618b2231b3b1" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
<div>
<input type="hidden" name="RadScriptManager1_TSM" id="RadScriptManager1_TSM" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAcgtc2EaMBGhTIuQWGow5nwoAKRIQI7t+Xnx2Ax7WHmeC2nlogNZq/fS333AprDxaJh2GRbbs6QBAjOHDtQlP/KTDDMxe8EhUqIZj21PVEpXpCa0B79kq9l3JDlaitvhuurZDK1MqhVkM0CetxGu82rr3KNYWYP5SbUjA+wHhVfAEjUqTU=" />
</div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="../../Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=f3e89837-a9ba-4353-9c0b-ded038bf92a9" style="height:50px;width:150px;border-width:0px;display:block;" />
...
Sys.Application.add_init(function() {
    $create(Telerik.Web.UI.RadCaptcha, {"_audioUrl":"/Telerik.Web.UI.WebResource.axd?type=cah\u0026guid=f3e89837-a9ba-4353-9c0b-ded038bf92a9","_enableAudio":false,"clientStateFieldID":"ctl06_ctl01_RadCaptcha1_ClientState"}, null, null, $get("ctl06_ctl01_RadCaptcha1"));
});
