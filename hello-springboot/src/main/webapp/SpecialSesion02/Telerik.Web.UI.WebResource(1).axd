...
<link rel="shortcut icon" type="image/png" href="/Resources/Imagephoto/logo.png" /><link href="/Components/lightbox/css/lightbox.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function popunder() {
            ...
            var articleId = '' != '' ? '' : '3af2fa01-2645-4516-a65a-67bfec768e13/Telerik.Web.UI.WebResource.axd';
            var topicId = '' != '' ? '' : '';
            var moduleId = '' != '' ? '' : '';
            if (articleId != '') {
                if (window.history.state == null) {
                    ...
                    window.history.replaceState({ ArticleId: articleId }, "ArticleId", "/ArticleId/" + articleId + "/" + retitleUrl('SPECIAL SESSION 02 FOR ICSSE2017: FUZZY SYSTEMS AND ITS APPLICATIONS'));
                }
            }
            if (topicId != '') {
                if (window.history.state == null) {
...
<body class="body" onload='popunder();'>
    ...
    <form name="form1" method="post" action="Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=df5df848-7f6e-471c-9817-2ef46875660d" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
<div>
<input type="hidden" name="RadScriptManager1_TSM" id="RadScriptManager1_TSM" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAeSlFLyJOK2i94PQpGajwtZoAKRIQI7t+Xnx2Ax7WHmeC2nlogNZq/fS333AprDxaJh2GRbbs6QBAjOHDtQlP/KTDDMxe8EhUqIZj21PVEpXpCa0B79kq9l3JDlaitvhuurZDK1MqhVkM0CetxGu82rKITzZX9H0HxdlZGKrD/1f44zVI8=" />
</div>
            ...
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                    <div class="articleTitle">
                        <a href="/?ArticleId=3af2fa01-2645-4516-a65a-67bfec768e13">SPECIAL SESSION 02 FOR ICSSE2017: FUZZY SYSTEMS AND ITS APPLICATIONS</a>
                    </div>
...
<div style="text-align: center;"><span style="font-size: 16px;"><img alt="" src="/Resources/Images/SubDomain/icsse2017/SS02.png" style="text-indent: 21.3pt;" /></span></div>
<span style="font-size: 16px;"><br />
...
E-mail: <a href="wjwang@ee.ncu.edu.tw">wjwang@ee.ncu.edu.tw</a><br />
</span><br />
<br />
</span></span></div>
                    </div>
            ...
            <div style="float: left; width: 670px; margin-bottom: 10px; padding-top: 5px; clear: both; margin: 0px 5px 0px 5px;">
                <div id="ctl06_ctl01_pnCactinkhac">
                    ...
                    <ul>
                                ...
                                <li class="tinkhac_display"><a href="/?ArticleId=bc474489-26ce-4997-a1c0-b37dce27b202">
                                ...
                                <li class="tinkhac_display"><a href="/?ArticleId=f796f938-0681-4d25-b47e-6bcd24536152">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="../../Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=73c0e9f5-abe8-44de-838e-9a7f11cee9ae" style="height:50px;width:150px;border-width:0px;display:block;" />
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">6,389</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">14,830</span></p>
</div>
...
Sys.Application.add_init(function() {
    $create(Telerik.Web.UI.RadCaptcha, {"_audioUrl":"/Telerik.Web.UI.WebResource.axd?type=cah\u0026guid=73c0e9f5-abe8-44de-838e-9a7f11cee9ae","_enableAudio":false,"clientStateFieldID":"ctl06_ctl01_RadCaptcha1_ClientState"}, null, null, $get("ctl06_ctl01_RadCaptcha1"));
});
