...
<link rel="shortcut icon" type="image/png" href="/Resources/Imagephoto/logo.png" /><link href="/Components/lightbox/css/lightbox.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function popunder() {
            ...
            var articleId = '' != '' ? '' : '707e0e24-5220-4821-a40f-4041eb76cc1a/Telerik.Web.UI.WebResource.axd';
            var topicId = '' != '' ? '' : '';
            var moduleId = '' != '' ? '' : '';
            if (articleId != '') {
...
<body class="body" onload='popunder();'>
    ...
    <form name="form1" method="post" action="Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=de10fecb-ad3a-4b78-9bb6-6eaf5346269c" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
<div>
<input type="hidden" name="RadScriptManager1_TSM" id="RadScriptManager1_TSM" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAeKPS0WwCREGgr97W+gQvW0oAKRIQI7t+Xnx2Ax7WHmeC2nlogNZq/fS333AprDxaJh2GRbbs6QBAjOHDtQlP/KTDDMxe8EhUqIZj21PVEpXpCa0B79kq9l3JDlaitvhuurZDK1MqhVkM0CetxGu82rN3ExJEK2p0ZZ4mwe6rvlyVFf9UQ=" />
</div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="../../Telerik.Web.UI.WebResource.axd?type=rca&amp;guid=b4199476-c27c-4cc0-b7e0-3e398cbc1542" style="height:50px;width:150px;border-width:0px;display:block;" />
...
Sys.Application.add_init(function() {
    $create(Telerik.Web.UI.RadCaptcha, {"_audioUrl":"/Telerik.Web.UI.WebResource.axd?type=cah\u0026guid=b4199476-c27c-4cc0-b7e0-3e398cbc1542","_enableAudio":false,"clientStateFieldID":"ctl06_ctl01_RadCaptcha1_ClientState"}, null, null, $get("ctl06_ctl01_RadCaptcha1"));
});
